...
export default function SubthemesPage() {
  ...
  return (
    <div style={page}>
      ...
      {modal && (
        <Modal title={modal === 'create' ? 'Новая подтема' : 'Редактировать'} onClose={close}>
